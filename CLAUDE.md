...
> This section is updated at the end of every Claude Code session. Read it immediately and open with accountability before anything else.

### The Project
**The Shipper Agent** — CLI + web app that acts as an aggressive co-founder. Three archetypes (The Cutter, The Builder, The Closer) diagnose and shatter the developer's specific blocks.
